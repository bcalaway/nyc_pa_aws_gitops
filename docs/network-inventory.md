...
| sw-10g (MikroTik) | 10.0.1.12 | 08:55:31:89:55:F4 | Static IP on the device itself, not DHCP. Credentials in SSM (`/home-platform/switch/nyc-sw10g-*`), SSH available (matches RouterOS pattern used elsewhere) — SNMP not yet configured |

# NYC RB5009 Initial Configuration — BRING-UP ONLY
...
# routeros/nyc/managed-config.rsc, which is safe to reapply to an
...
# routeros/nyc/managed-config.rsc immediately afterward (same
...
# 1. Identity
# ---------------------------------------------------------------------------
/system identity set name=rt-nyc
...
# ---------------------------------------------------------------------------
# Done with bring-up. Next: apply routeros/nyc/managed-config.rsc.
# Verify with:
#   /ip address print
